            ...
            <div className="card">
              <div className="card-body">
                ...
                <section className="card-text text-muted">
                  ...
                  In view of this, institutional emails have been generated for
            ...
            <div className="card">
              <div className="card-body">
                <h6 className="card-title text-danger text-uppercase">
                  ...
                  OF LEVELS 100, 200 AND 300 STUDENTS TO COMPLETE THE 2019/2020
                  ACADEMIC YEAR
                </h6>
                <section className="card-text text-muted">
                  Members of the University community and the general public are
                  hereby informed that the University will re-open on Tuesday
                  1st September, 2020 to enable levels 100, 200 and 300
                  undergraduate students to come to campus to write end of
                  second semester examinations for the 2019/2020 academic year.
            ...
            <div className="card">
              <div className="card-body">
                ...
                <section className="card-text text-muted">
                  ...
                  campus that its offer of free accommodation to them remains
                  open{" "}
                  <a
            ...
            <div className="card">
              <div className="card-body">
                ...
                <section className="card-text text-muted">
                  ...
                  distancing protocols, the Counselling Centre deems it
                  necessary to initiate a mobile phone call-in counselling mode
                  for students of UCC.
                  <a
            ...
            <div className="card">
              <div className="card-body">
                ...
                <section className="card-text text-muted">
                  ...
                  business idea in the food processing and consumer Goods
                  Industy?{" "}
                  <a
            ...
            <div className="card">
              <div className="card-body">
                ...
                <section className="card-text text-muted">
                  ...
                  opportunities to register. The deadline for the application is{" "}
                  <b>15th May, 2020</b>.{" "}
                  <a
            ...
            <div className="card">
              <div className="card-body">
                ...
                <section className="card-text text-muted">
                  ...
                  deploy immediately an online platform for support teaching and
                  learning activities even in this COVID-19 era.{" "}
                  <a
                    href="elearning.php"
                    target="content"
                    className="btn btn-link btn-sm"
            ...
            <div className="card">
              <div className="card-body">
                ...
                <section className="card-text text-muted">
                  ...
                  academic work for the second semester of the 2019/2020
                  academic year which was suspended from Monday, 16th March,
                  2020{" "}
                  <a
              ...
              <div className="card-body">
                ...
                <section className="card-text text-muted">
                  <p>
                    ...
                    courses is scheduled to take place from Monday, 16th
                    September to Friday, 20th September, 2019.
                  </p>
                  <p>
                    The examination is for Level 100 students who failed the
                    First Supplementary (Re-Sit) Examination which was conducted
                    from Monday, 19th August to Friday, 23rd August, 2019 and
                    those who did not avail themselves for the first
                    examination.
                  </p>
                  <p>
                    The affected students are to pay the re-sit fee of Fifty
                    Ghana Cedis (GH¢50.00) per a paper at the Cash Office from
                    Monday, 2nd September, 2019 and send the receipt to Room DF3
                    at Directorate of Finance for endorsement and registration.
                    The deadline for registration is Thursday, 12th September,
                    2019. Students are advised to check their results and have
                    all ICs rectified promptly.
                  </p>
                  <p>
